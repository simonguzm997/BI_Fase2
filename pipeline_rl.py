...
pre = [('scaler', MinMaxScaler())]


# In[26]:


modelo = [('model', linear_model.LogisticRegression())]


# In[27]:


pipe_lr = Pipeline(pre+modelo)


# In[28]:


pipe_lr = pipe_lr.fit(X,y)


# In[32]:


# Exportacion a Joblib:
...
#pipe_lr2 = Pipeline(pre+modelo)


# In[ ]:


#pipe_lr2 = pipe_lr2.fit(X_train,Y_train)
